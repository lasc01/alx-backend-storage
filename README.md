...
File: 4-store.sql - 4-init.sql - 4-main.sql
...
File: 5-valid_email.sql - 5-init.sql - 5-main.sql
...
File: 6-bonus.sql - 6-init.sql - 6-main.sql
...
File: 7-average_score.sql - 7-init.sql - [7-main.sql]7-main.sql/)
...
Files: 8-index_my_names.sql - names.sql
...
File: 9-index_name_score.sql - names.sql
...
File: 11-need_meeting.sql - 11-init.sql - 11-main.sql
...
File: 100-average_weighted_score.sql - 100-init.sql - 100-main.sql
...
File: 101-average_weighted_score.sql - 101-init.sql - 101-main.sql
